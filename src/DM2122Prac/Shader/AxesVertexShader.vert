...
/* File: AxesVertexShader.vert
   Use: Handle conversion of axes in model space to view space 
...
// Info about line
layout(location = 3) in vec3 vertexPosition_modelspace; // Vertex info
layout(location = 4) in vec3 vertexColor; // Color info
...
// Uniform block for model and view matrices, directional and point lights (unused in this shader)
