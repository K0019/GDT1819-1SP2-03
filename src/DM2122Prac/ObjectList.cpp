...
{
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//trackTest.obj", "Image//PlaceableObjects//trackTestUV.tga", type::SHADER_3, 10, 10));
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//trackTurnAngled.obj", "Image//PlaceableObjects//trackTestUV.tga", type::SHADER_3, 10, 10));
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//trackTurnCurved.obj", "Image//PlaceableObjects//trackTestUV.tga", type::SHADER_3, 10, 10));
	// Source: https://www.turbosquid.com/3d-models/free-3ds-model-tree-arbaro-cheetah/669717
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//deadTree.obj", "Image//PlaceableObjects//deadTree.tga", type::SHADER_3, 2, 2));
	// Source: https://www.turbosquid.com/3d-models/free-obj-model-mapped/723445
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//stone.obj", "Image//PlaceableObjects//stone.tga", type::SHADER_3, 2, 2));
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//woodenBox.obj", "Image//PlaceableObjects//woodenBox.tga", type::SHADER_3, 2, 2));
