...
void ObjectList::init()
{
	...
	meshes.push_back(MeshBuilder::GenerateMeshPlaceable("OBJ//PlaceableObjects//modi_gate.obj", "Image//PlaceableObjects//modi_gate_texture.tga", type::SHADER_3, 2, 10, true));
